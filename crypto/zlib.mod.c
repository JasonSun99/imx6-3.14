...
__attribute__((section("__versions"))) = {
	...
	{ 0x7356694, __VMLINUX_SYMBOL_STR(crypto_unregister_pcomp) },
	{ 0x14d69cd0, __VMLINUX_SYMBOL_STR(crypto_register_pcomp) },
...
MODULE_INFO(srcversion, "82F0F43B2C7D793A1962007");
