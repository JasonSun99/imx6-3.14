...
__attribute__((section("__versions"))) = {
	...
	{ 0x980999a, __VMLINUX_SYMBOL_STR(rtl2830_get_tuner_i2c_adapter) },
	...
	{ 0xede731d8, __VMLINUX_SYMBOL_STR(ir_raw_event_set_idle) },
};
...
MODULE_INFO(srcversion, "E00EB39E4FFD3DFB3557B79");
