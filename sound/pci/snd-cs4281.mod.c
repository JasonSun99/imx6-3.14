...
__attribute__((section("__versions"))) = {
	...
	{ 0x736121c6, __VMLINUX_SYMBOL_STR(snd_opl3_init) },
	{ 0xe707d823, __VMLINUX_SYMBOL_STR(__aeabi_uidiv) },
	{ 0x5d41c87c, __VMLINUX_SYMBOL_STR(param_ops_charp) },
	{ 0x80943d4a, __VMLINUX_SYMBOL_STR(pci_set_master) },
	{ 0x69824e7c, __VMLINUX_SYMBOL_STR(snd_opl3_new) },
...
"depends=snd-opl3-lib,snd-rawmidi,gameport";

MODULE_ALIAS("pci:v00001013d00006005sv*sd*bc*sc*i*");

MODULE_INFO(srcversion, "3501209A4BE8967C67EF183");
